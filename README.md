...
<h2>3. Регистрация заказа в системе</h2>
...
<h2>4. Установка статуса заказа водителем и пассажиром</h2>
...
<h2>5. Получить данные для отображения карты</h2>
